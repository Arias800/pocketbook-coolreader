...
struct BookProperties {
  ...
  char filedate[MAX_PROPERTY_LEN]; // Printable file date. for example
                                   // 08/22/2007
  ...
  char original_name[MAX_PROPERTY_LEN];   // name of book in original language,
                                          // for translation
  char original_author[MAX_PROPERTY_LEN]; // author(s) in original language, for
                                          // translation
  char original_series[MAX_PROPERTY_LEN]; // author(s) in original language, for
                                          // translation
