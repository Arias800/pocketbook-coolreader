      ...
      if (buf->GetBitsPerPixel() == 2) {
        ...
        for (int i = 0; i < linesz; i++) {
          ...
          if (false) {
            // min
#if GRAY_INVERSE == 1
            n1 = maxBits(n1, n2, 0x03) | maxBits(n1, n2, 0x0C) |
                 maxBits(n1, n2, 0x30) | maxBits(n1, n2, 0xC0);
#else
            n1 = minBits(n1, n2, 0x03) | minBits(n1, n2, 0x0C) |
                 minBits(n1, n2, 0x30) | minBits(n1, n2, 0xC0);
#endif
          } else {
            // blend
