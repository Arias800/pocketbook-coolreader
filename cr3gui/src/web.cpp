...
//---------------------------------------------------------------------------
string web::easycurl(const string &url, bool post,
  ...
  if (curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_SSL_VERIFYPEER,
                     false); // this line makes it work under https
    curl_easy_setopt(curl, CURLOPT_COOKIEFILE,
                     LIB_CURL_COOKIES_FILE); // read from
    curl_easy_setopt(curl, CURLOPT_COOKIEJAR, LIB_CURL_COOKIES_FILE); // write
                                                                      // to
...
//---------------------------------------------------------------------------
bool web::easycurlBinary(const string &url, bool post,
                         const string &postparamstring,
                         const string &outfilename) {
  CRLog::trace("web::easycurlBinary(%s, bool, %s, %s)", url.c_str(),
               postparamstring.c_str(), outfilename.c_str());
  ...
  if (curl) {
    ...
    // Attempt to retrieve the remote page
    CRLog::trace(
        "web::easycurlBinary(): Attempt to retrieve the remote binary");
    result = curl_easy_perform(curl);
