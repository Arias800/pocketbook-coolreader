...
// #define OTA_URL_BASE
// "http://sourceforge.net/u/e379d14417/crengine/ci/pocketbook-port/tree/builds/"
// #define OTA_URL_POST      "?format=raw"
// #define OTA_URL_MASK      OTA_URL_BASE "[DEVICE]/" CR_PB_SDK "/"
// OTA_PACKAGE_NAME OTA_URL_POST #define OTA_URL_MASK_TEST OTA_URL_BASE
// "[DEVICE]/" CR_PB_SDK "/exists" OTA_URL_POST #define OTA_VERSION OTA_URL_BASE
// "current.version" OTA_URL_POST #define OTA_LINK_MASK     OTA_URL_BASE
// "links/[DEVICE]" OTA_URL_POST

// Github [current source]
#define OTA_BRANCH_STABLE "master"
#define OTA_BRANCH_DEV "dev"
#define OTA_URL_BASE                                                           \
  "https://raw.githubusercontent.com/blchinezu/pocketbook-coolreader/"         \
  "[BRANCH]/builds/"
