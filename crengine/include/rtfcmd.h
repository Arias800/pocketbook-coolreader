...
RTF_TPR(clmgf, tpi_clmgf,
        0) // The first cell in a range of table cells to be merged.
RTF_TPR(clmrg, tpi_clmrg, 0) // Contents of the table cell are merged with those
                             // of the preceding cell.
RTF_TPR(clvmgf, tpi_clvmgf,
        0) // The first cell in a range of table cells to be vertically merged.
RTF_TPR(clvmrg, tpi_clvmrg, 0) // Contents of the table cell are vertically
                               // merged with those of the preceding cell.
...
RTF_TPR(irowband, tpi_irowbandN,
        0) // N is the row index of the row, adjusted to account for header
           // rows. A header row has a value of –1.
