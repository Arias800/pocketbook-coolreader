...
#define XS_BEGIN_TAGS enum { el_NULL = 0,
#define XS_TAG1(itm) el_##itm,
#define XS_TAG2(itm, name) el_##itm,
#define XS_TAG1T(itm) el_##itm,
#define XS_TAG1OBJ(itm) el_##itm,
#define XS_TAG2T(itm, name) el_##itm,
#define XS_TAG1I(itm) el_##itm,
#define XS_TAG2I(itm, name) el_##itm,
#define XS_TAG1D(itm, txt, disp, ws) el_##itm,
#define XS_TAG2D(itm, name, txt, disp, ws) el_##itm,
#define XS_END_TAGS                                                            \
  el_MAX_ID                                                                    \
  }                                                                            \
  ;

#define XS_BEGIN_ATTRS enum { attr_NULL = 0,
#define XS_ATTR(itm) attr_##itm,
#define XS_ATTR2(itm, name) attr_##itm,
#define XS_END_ATTRS                                                           \
  attr_MAX_ID                                                                  \
  }                                                                            \
  ;

#define XS_BEGIN_NS enum { ns_NULL = 0,
#define XS_NS(itm) ns_##itm,
#define XS_END_NS                                                              \
  ns_MAX_ID                                                                    \
  }                                                                            \
  ;
...
#undef XS_TAG2D
#undef XS_END_TAGS
#define XS_BEGIN_TAGS static elem_def_t fb2_elem_table[] = {
#define XS_TAG1(itm)                                                           \
...
#define XS_TAG1D(itm, txt, disp, ws) {el_##itm, #itm, {txt, false, disp, ws}},
...
#undef XS_ATTR2
#undef XS_END_ATTRS
#define XS_BEGIN_ATTRS static attr_def_t fb2_attr_table[] = {
#define XS_ATTR(itm) {attr_##itm, #itm},
#define XS_ATTR2(itm, name) {attr_##itm, name},
#define XS_END_ATTRS                                                           \
  { 0, NULL }                                                                  \
  }                                                                            \
  ;
...
#undef XS_NS
#undef XS_END_NS
#define XS_BEGIN_NS static ns_def_t fb2_ns_table[] = {
#define XS_NS(itm) {ns_##itm, #itm},
#define XS_END_NS                                                              \
  { 0, NULL }                                                                  \
  }                                                                            \
  ;
