...
enum text_selection_cmd_t {
  ...
  CMD_SEL_MIDDLE_INTERVAL,    // select middle interval (word/sentence/paragraph
                           // depending on current setting) for initial interval
  ...
  CMD_SEL_CUR_INTERVAL_TOGGLE,    // toggle current interval:
  ...
  CMD_SEL_START_FWD_BY_INTERVAL,  // move selection start - forward by current
  ...
  CMD_SEL_START_BACK_BY_INTERVAL, // move selection start - back by interval
                                  // (word/sentence/para)
  ...
  CMD_SEL_END_FWD_BY_INTERVAL,    // move selection end - forward by interval
                                  // (word/sentence/para)
  ...
  CMD_SEL_END_BACK_BY_INTERVAL,   // move selection end - back by interval
                                  // (word/sentence/para)
  ...
  CMD_SEL_ALL_FWD_BY_INTERVAL, // move selection start+end - forward by interval
                               // (word/sentence/para)
  ...
  CMD_SEL_ALL_BACK_BY_INTERVAL, // move selection start+end - back by interval
                                // (word/sentence/para)
  CMD_SEL_CUR_FWD_BY_WORD,      // move selection depending on current mode
                                // (start/end/both) - forward by word
  CMD_SEL_CUR_FWD_BY_SENTENCE,  // move selection depending on current mode
                                // (start/end/both) - forward by sentence
  CMD_SEL_CUR_FWD_BY_PARA,      // move selection depending on current mode
                                // (start/end/both) - forward by paragraph
  CMD_SEL_CUR_FWD_BY_INTERVAL,  // move selection depending on current mode
                                // (start/end/both) - forward by interval
                                // (word/sentence/para)
  CMD_SEL_CUR_BACK_BY_WORD,     // move selection depending on current mode
                                // (start/end/both) - back by word
  CMD_SEL_CUR_BACK_BY_SENTENCE, // move selection depending on current mode
                                // (start/end/both) - back by sentence
  CMD_SEL_CUR_BACK_BY_PARA,     // move selection depending on current mode
                                // (start/end/both) - back by paragraph
  CMD_SEL_CUR_BACK_BY_INTERVAL  // move selection depending on current mode
...
public:
  enum interval_t { WORD, SENTENCE, PARA };
  enum direction_t { FORWARD, BACK };
  enum origin_t { START, END, ALL };
...
public:
  ...
  ldomTextSelectionTool(ldomXRange &initialRange, interval_t initialInterval,
                        origin_t initialOrigin);
  ...
  bool moveBy(interval_t interval, direction_t dir, origin_t origin, int count,
