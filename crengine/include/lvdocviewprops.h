...
#define PROP_FONT_GAMMA                                                        \
  "font.gamma" // currently supported: 0.65 .. 1.35, see gammatbl.h
#define PROP_FONT_GAMMA_INDEX                                                  \
  "font.gamma.index" // currently supported: 0..30 ~= 0.65 .. 1.35, see
                     // gammatbl.h
...
#define PROP_DISPLAY_FULL_UPDATE_INTERVAL                                      \
  "crengine.display.full.update.interval"
...
#define PROP_FORMAT_MIN_SPACE_CONDENSING_PERCENT                               \
  "crengine.style.space.condensing.percent"
#define PROP_FORMAT_MAX_SPACE_EXPANDING_PERCENT                                \
  "crengine.style.space.expanding.percent"
...
#define PROP_HIGHLIGHT_BOOKMARK_COLOR_COMMENT                                  \
  "crengine.highlight.bookmarks.color.comment"
#define PROP_HIGHLIGHT_BOOKMARK_COLOR_CORRECTION                               \
  "crengine.highlight.bookmarks.color.correction"
// image scaling settings
// mode: 0=disabled, 1=integer scaling factors, 2=free scaling
// scale: 0=auto based on font size, 1=no zoom, 2=scale up to *2, 3=scale up to
// *3
#define PROP_IMG_SCALING_ZOOMIN_INLINE_MODE                                    \
  "crengine.image.scaling.zoomin.inline.mode"
#define PROP_IMG_SCALING_ZOOMIN_INLINE_SCALE                                   \
  "crengine.image.scaling.zoomin.inline.scale"
#define PROP_IMG_SCALING_ZOOMOUT_INLINE_MODE                                   \
  "crengine.image.scaling.zoomout.inline.mode"
#define PROP_IMG_SCALING_ZOOMOUT_INLINE_SCALE                                  \
  "crengine.image.scaling.zoomout.inline.scale"
#define PROP_IMG_SCALING_ZOOMIN_BLOCK_MODE                                     \
  "crengine.image.scaling.zoomin.block.mode"
#define PROP_IMG_SCALING_ZOOMIN_BLOCK_SCALE                                    \
  "crengine.image.scaling.zoomin.block.scale"
#define PROP_IMG_SCALING_ZOOMOUT_BLOCK_MODE                                    \
  "crengine.image.scaling.zoomout.block.mode"
#define PROP_IMG_SCALING_ZOOMOUT_BLOCK_SCALE                                   \
