...
/// zlib stream decode cache size, used to avoid restart of decoding from
/// beginning to move back
...
/// Document caching file size threshold (bytes). For longer documents, swapping
/// to disk should occur
