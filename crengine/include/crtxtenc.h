...
/**
    \brief Searches for 8-bit encoding to unicode conversion table by encoding
   name.
...
/// get conversion table for upper 128 characters of codepage, by codepage
/// number
...
/**
    ...
    \param cp_name is buffer to store autodetected name of encoding, i.e.
   "utf-8", "windows-1251" \param lang_name is buffer to store autodetected name
   of language, i.e. "en", "ru"
...
/**
    \brief Autodetects encoding of text data in buffer, only using ByteOrderMark
   or Utf-8 validity detection.

    \param buf is buffer with text data to autodetect
    \param buf_size is size of data in buffer, bytes
    \param cp_name is buffer to store autodetected name of encoding, i.e.
   "utf-8", "windows-1251" \param lang_name is buffer to store autodetected name
   of language, i.e. "en", "ru" \param skipHtml if true, skip HTML/XML tags
