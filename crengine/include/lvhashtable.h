...
inline lUInt32 getHash(lUInt16 n) { return (lUInt32)n * 1975317 + 164521; }

inline lUInt32 getHash(lUInt32 n) { return n * 1975317 + 164521; }
...
class LVFont;
inline lUInt32 getHash(LVFont *n) { return getHash((lUInt64)n); }

inline lUInt32 getHash(void *n) { return getHash((lUInt64)n); }
...
public:
  ...
  public:
    ...
    pair(const keyT &nkey, valueT nvalue, pair *pnext)
        : next(pnext), key(nkey), value(nvalue) {}
  };
  ...
  public:
    iterator(const LVHashTable &table) : _tbl(table), index(0), ptr(NULL) {}
  ...
  iterator forwardIterator() const { return iterator(*this); }
