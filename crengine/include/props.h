...
public:
  ...
  virtual lString16 getStringDef(const char *propName,
                                 const char *defValue = NULL) const;
  ...
  /// do validation and corrections
  virtual void limitValueList(const char *propName, int values[],
                              int value_count);
  /// do validation and corrections
  virtual void limitValueRange(const char *propName, int defValue, int minValue,
                               int maxValue);
  ...
  /// get argb color (#xxxxxx) property by name, returns default value if not
  /// found
  ...
  virtual lvPoint getPointDef(const char *propName,
